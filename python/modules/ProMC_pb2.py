...
_PROMCEVENT_EVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='Weight', full_name='promc.ProMCEvent.Event.Weight', index=13,
